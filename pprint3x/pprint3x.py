...
# Backport for Python 3.6 ... 3.10
# taken from version 3.10.1 on 2021-12-30 by bitranox
...
if __name__ == "__main__":
    print(b'this is a library only, the executable is named "pprint3x_cli.py"', file=_sys.stderr)

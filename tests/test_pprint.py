...
[   dataclass1(field1='some fairly long text',
    ...
    def test_dataclass_no_repr(self):
        ...
        self.assertRegex(formatted, r"<test_pprint.dataclass3 object at \w+>")
...
{'names with spaces': 'should be presented using repr()',
 others.should.not.be: like.this}"""
    ...
    def test_set_reprs(self):
        ...
        self.assertEqual(
            pprint.pformat(set(range(7)), width=20),
            """\
{0,
 1,
 2,
...
[[], [0], [0, 1, 2, 3],
 ...
 [0, 1, 2, 3, 4]]"""
    ...
    def test_bytes_wrap(self):
        ...
        self.assertEqual(
            pprint.pformat(letters, width=19),
            """\
(b'abcdefghijkl'
 b'mnopqrstuvwxyz')""",
        )
        self.assertEqual(
            pprint.pformat(letters, width=18),
            """\
(b'abcdefghijkl'
 b'mnopqrstuvwx'
 b'yz')""",
        ...
        self.assertEqual(
            pprint.pformat(letters, width=16),
            """\
(b'abcdefghijkl'
 b'mnopqrstuvwx'
 b'yz')""",
